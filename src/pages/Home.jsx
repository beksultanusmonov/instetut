    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 md:mb-4">Mavjud Testlar</h2>
          <p className="text-gray-600 text-sm md:text-base">O'zingizga mos testni tanlang</p>
        </div>
...
<div className="group">
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Kiber Xavfsizlik</h3>
                <p className="text-gray-600 mb-3 md:mb-4 text-sm md:text-base">IV semestr KiberXavfsizlik fani uchun oraliq test</p>
                <Link
          ...
          <div className="group">
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Ma'lumotlar Bazasi</h3>
                <p className="text-gray-600 mb-3 md:mb-4 text-sm md:text-base">III-semestr Yakuniy nazorat uchun</p>
                <Link
                  to="/test?quiz=baza"
          ...
          <div className="group">
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Kompyuter Tarmoqlari</h3>
                <p className="text-gray-600 mb-3 md:mb-4 text-sm md:text-base">III-semestr Yakuniy nazorat uchun</p>
                <Link
                  to="/test?quiz=tarmoq"
          ...
          <div className="group">
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Ma'lumotlar Bazasi</h3>
                <p className="text-gray-600 mb-3 md:mb-4 text-sm md:text-base">III-semestr 21-kungi test oraliq sinov uchun</p>
                <Link
